...
function Avian(params) {
	...
	this.maxTweetsStored = 30; //configurable. how many do you want to keep around?
	this.defaultNumTweetsRequested = 30; //default number to obtain for methods like getHomeTimeline
